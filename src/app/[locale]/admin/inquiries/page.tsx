    ...
    <div className="space-y-8">
      ...
      {(!inquiries || inquiries.length === 0) ? (
        ...
        <div className="grid grid-cols-1 gap-4">
          {inquiries.map((inq) => (
            <Card key={inq.id} className="bg-[#111111] border-[var(--brand-gold)]/20">
              <CardHeader className="pb-3 flex flex-row justify-between items-start">
                <div>
                  <CardTitle className="text-lg font-bold text-white">{inq.name}</CardTitle>
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4 text-sm text-white/80">
                ...
                <div className="p-4 bg-black/40 rounded-lg text-white/90 text-sm whitespace-pre-wrap">
                  {inq.message}
                </div>
              </CardContent>
            </Card>
